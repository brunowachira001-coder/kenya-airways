...
const CORE_FLIGHTS: Omit<Flight, 'id'>[] = [
  ...
  // NBO ↔ CDG / AMS — ~8h
  { origin: 'NBO', destination: 'CDG', airline: 'Kenya Airways', flightNumber: 'KQ113', departureTime: '22:00', arrivalTime: '05:30+1', duration: '8h 30m', aircraft: 'Boeing 787-8', economyPrice: 23400, businessPrice: 99000, stops: 0, operatingDays: [1, 3, 5, 6] },
  { origin: 'CDG', destination: 'NBO', airline: 'Kenya Airways', flightNumber: 'KQ112', departureTime: '10:00', arrivalTime: '19:30', duration: '8h 30m', aircraft: 'Boeing 787-8', economyPrice: 22800, businessPrice: 96000, stops: 0, operatingDays: [1, 3, 5, 6] },
  { origin: 'NBO', destination: 'AMS', airline: 'Kenya Airways', flightNumber: 'KQ115', departureTime: '21:00', arrivalTime: '04:30+1', duration: '8h 30m', aircraft: 'Boeing 787-8', economyPrice: 22500, businessPrice: 94500, stops: 0, operatingDays: [0, 2, 4] },
  { origin: 'AMS', destination: 'NBO', airline: 'Kenya Airways', flightNumber: 'KQ114', departureTime: '11:00', arrivalTime: '20:30', duration: '8h 30m', aircraft: 'Boeing 787-8', economyPrice: 21900, businessPrice: 91500, stops: 0, operatingDays: [0, 2, 4] },
  ...
  { origin: 'NBO', destination: 'CAI', airline: 'Kenya Airways', flightNumber: 'KQ460', departureTime: '21:00', arrivalTime: '02:30+1', duration: '4h 30m', aircraft: 'Boeing 787-8', economyPrice: 16500, businessPrice: 66000, stops: 0, operatingDays: [1, 3, 5] },
  { origin: 'CAI', destination: 'NBO', airline: 'Kenya Airways', flightNumber: 'KQ461', departureTime: '03:30', arrivalTime: '09:00', duration: '4h 30m', aircraft: 'Boeing 787-8', economyPrice: 16500, businessPrice: 66000, stops: 0, operatingDays: [1, 3, 5] },
  ...
  // NBO ↔ SEZ — Seychelles
  { origin: 'NBO', destination: 'SEZ', airline: 'Kenya Airways', flightNumber: 'KQ570', departureTime: '10:00', arrivalTime: '12:00', duration: '2h 00m', aircraft: 'Boeing 737-800', economyPrice: 10500, businessPrice: 28500, stops: 0, operatingDays: [0, 2, 4, 6] },
  { origin: 'SEZ', destination: 'NBO', airline: 'Kenya Airways', flightNumber: 'KQ571', departureTime: '13:00', arrivalTime: '15:00', duration: '2h 00m', aircraft: 'Boeing 737-800', economyPrice: 10500, businessPrice: 28500, stops: 0, operatingDays: [0, 2, 4, 6] },

  // NBO ↔ MRU — Mauritius
  { origin: 'NBO', destination: 'MRU', airline: 'Kenya Airways', flightNumber: 'KQ580', departureTime: '09:00', arrivalTime: '13:00', duration: '4h 00m', aircraft: 'Boeing 787-8', economyPrice: 20400, businessPrice: 78000, stops: 0, operatingDays: [1, 4, 6] },
  { origin: 'MRU', destination: 'NBO', airline: 'Kenya Airways', flightNumber: 'KQ581', departureTime: '14:00', arrivalTime: '18:00', duration: '4h 00m', aircraft: 'Boeing 787-8', economyPrice: 20400, businessPrice: 78000, stops: 0, operatingDays: [1, 4, 6] },
  ...
  // NBO ↔ FRA — Germany
  { origin: 'NBO', destination: 'FRA', airline: 'Kenya Airways', flightNumber: 'KQ117', departureTime: '21:30', arrivalTime: '05:30+1', duration: '8h 00m', aircraft: 'Boeing 787-8', economyPrice: 24000, businessPrice: 102000, stops: 0, operatingDays: [1, 3, 5] },

  // NBO ↔ ZRH — Switzerland
  { origin: 'NBO', destination: 'ZRH', airline: 'Kenya Airways', flightNumber: 'KQ119', departureTime: '20:30', arrivalTime: '04:30+1', duration: '8h 00m', aircraft: 'Boeing 787-8', economyPrice: 24600, businessPrice: 103500, stops: 0, operatingDays: [0, 2, 4, 6] },

  // NBO ↔ FCO — Rome
  { origin: 'NBO', destination: 'FCO', airline: 'Kenya Airways', flightNumber: 'KQ121', departureTime: '22:00', arrivalTime: '06:00+1', duration: '8h 00m', aircraft: 'Boeing 787-8', economyPrice: 23700, businessPrice: 100500, stops: 0, operatingDays: [1, 3, 5, 6] },

  // NBO ↔ MAD — Madrid
  { origin: 'NBO', destination: 'MAD', airline: 'Kenya Airways', flightNumber: 'KQ123', departureTime: '21:00', arrivalTime: '05:00+1', duration: '8h 00m', aircraft: 'Boeing 787-8', economyPrice: 23100, businessPrice: 97500, stops: 0, operatingDays: [0, 2, 4] },
  ...
  { origin: 'NBO', destination: 'YYZ', airline: 'Kenya Airways', flightNumber: 'KQ104', departureTime: '22:00', arrivalTime: '06:00+1', duration: '14h 00m', aircraft: 'Boeing 787-8', economyPrice: 46500, businessPrice: 186000, stops: 0, operatingDays: [1, 4, 6] },

  // NBO ↔ CMN — Casablanca
  { origin: 'NBO', destination: 'CMN', airline: 'Kenya Airways', flightNumber: 'KQ130', departureTime: '20:00', arrivalTime: '03:30+1', duration: '7h 30m', aircraft: 'Boeing 787-8', economyPrice: 19500, businessPrice: 78000, stops: 0, operatingDays: [0, 3, 5] },
