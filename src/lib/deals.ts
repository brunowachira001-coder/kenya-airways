...
const BASE_DEALS: Omit<Deal, 'dateRange'>[] = [
  ...
  { id: 5, origin: "NBO", destination: "CPT", originCity: "Nairobi", destinationCity: "Cape Town", country: "South Africa", region: "Africa", price: "KES 38,500", priceNumber: 38500, image: "/cape-town.jpg", cabinClass: "Economy", startDaysFromNow: 10, durationDays: 7, tripType: "one-way" },
  ...
  { id: 10, origin: "NBO", destination: "CDG", originCity: "Nairobi", destinationCity: "Paris", country: "France", region: "Europe", price: "KES 52,000", priceNumber: 52000, image: "/paris.jpg", cabinClass: "Economy", startDaysFromNow: 15, durationDays: 7, tripType: "one-way" },
  { id: 11, origin: "NBO", destination: "AMS", originCity: "Nairobi", destinationCity: "Amsterdam", country: "Netherlands", region: "Europe", price: "KES 54,000", priceNumber: 54000, image: "/amsterdam.jpg", cabinClass: "Economy", startDaysFromNow: 18, durationDays: 7, tripType: "one-way" },
  { id: 12, origin: "NBO", destination: "FRA", originCity: "Nairobi", destinationCity: "Frankfurt", country: "Germany", region: "Europe", price: "KES 50,000", priceNumber: 50000, image: "/frankfurt.jpg", cabinClass: "Economy", startDaysFromNow: 20, durationDays: 8, tripType: "one-way" },
  { id: 13, origin: "NBO", destination: "FCO", originCity: "Nairobi", destinationCity: "Rome", country: "Italy", region: "Europe", price: "KES 56,000", priceNumber: 56000, image: "/rome.jpg", cabinClass: "Economy", startDaysFromNow: 22, durationDays: 8, tripType: "one-way" },

  // Asia deals (4+) - Medium to long haul (5-8 days)
  { id: 14, origin: "NBO", destination: "DXB", originCity: "Nairobi", destinationCity: "Dubai", country: "UAE", region: "Asia", price: "KES 28,000", priceNumber: 28000, image: "/dubai.jpg", cabinClass: "Economy", startDaysFromNow: 6, durationDays: 7, tripType: "one-way" },
  { id: 15, origin: "NBO", destination: "BOM", originCity: "Nairobi", destinationCity: "Mumbai", country: "India", region: "Asia", price: "KES 32,500", priceNumber: 32500, image: "/mumbai.jpg", cabinClass: "Economy", startDaysFromNow: 8, durationDays: 7, tripType: "one-way" },
  { id: 16, origin: "NBO", destination: "DEL", originCity: "Nairobi", destinationCity: "Delhi", country: "India", region: "Asia", price: "KES 34,000", priceNumber: 34000, image: "/delhi.jpg", cabinClass: "Economy", startDaysFromNow: 9, durationDays: 7, tripType: "one-way" },
  { id: 17, origin: "NBO", destination: "BKK", originCity: "Nairobi", destinationCity: "Bangkok", country: "Thailand", region: "Asia", price: "KES 42,500", priceNumber: 42500, image: "/bangkok.jpg", cabinClass: "Economy", startDaysFromNow: 11, durationDays: 8, tripType: "one-way" },

  // Middle East deals (3+) - Short to medium haul (4-7 days)
  { id: 18, origin: "NBO", destination: "AUH", originCity: "Nairobi", destinationCity: "Abu Dhabi", country: "UAE", region: "Middle East", price: "KES 26,500", priceNumber: 26500, image: "/abu-dhabi.jpg", cabinClass: "Economy", startDaysFromNow: 5, durationDays: 7, tripType: "one-way" },
  { id: 19, origin: "NBO", destination: "DOH", originCity: "Nairobi", destinationCity: "Doha", country: "Qatar", region: "Middle East", price: "KES 29,000", priceNumber: 29000, image: "/doha.jpg", cabinClass: "Economy", startDaysFromNow: 7, durationDays: 7, tripType: "one-way" },
  { id: 20, origin: "NBO", destination: "JED", originCity: "Nairobi", destinationCity: "Jeddah", country: "Saudi Arabia", region: "Middle East", price: "KES 30,500", priceNumber: 30500, image: "/jeddah.jpg", cabinClass: "Economy", startDaysFromNow: 10, durationDays: 7, tripType: "one-way" },

  // America deals (2+) - Very long haul (10-13 days)
  { id: 21, origin: "NBO", destination: "JFK", originCity: "Nairobi", destinationCity: "New York", country: "USA", region: "America", price: "KES 65,000", priceNumber: 65000, image: "/new-york.jpg", cabinClass: "Economy", startDaysFromNow: 21, durationDays: 13, tripType: "one-way" },
  { id: 22, origin: "NBO", destination: "YYZ", originCity: "Nairobi", destinationCity: "Toronto", country: "Canada", region: "America", price: "KES 68,000", priceNumber: 68000, image: "/toronto.jpg", cabinClass: "Economy", startDaysFromNow: 23, durationDays: 13, tripType: "one-way" },

  // Additional Africa deals for variety
  { id: 23, origin: "NBO", destination: "KIS", originCity: "Nairobi", destinationCity: "Kisumu", country: "Kenya", region: "Africa", price: "KES 4,200", priceNumber: 4200, image: "/kisumu.jpg", cabinClass: "Economy", startDaysFromNow: 3, durationDays: 7, tripType: "one-way" },
  ...
  { id: 27, origin: "NBO", destination: "JFK", originCity: "Nairobi", destinationCity: "New York", country: "USA", region: "America", price: "KES 162,500", priceNumber: 162500, image: "/new-york.jpg", cabinClass: "Business", startDaysFromNow: 21, durationDays: 13, tripType: "one-way" },
  { id: 28, origin: "NBO", destination: "DXB", originCity: "Nairobi", destinationCity: "Dubai", country: "UAE", region: "Asia", price: "KES 70,000", priceNumber: 70000, image: "/dubai.jpg", cabinClass: "Business", startDaysFromNow: 6, durationDays: 7, tripType: "one-way" },
]
